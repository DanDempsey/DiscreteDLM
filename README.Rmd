...
The idea is we take a dataset with longitudinal (binary or count) response and predictor data, and we want to fit the appropriate regression model to determine how the lags of the predictor affect the value of the response. TBD...
